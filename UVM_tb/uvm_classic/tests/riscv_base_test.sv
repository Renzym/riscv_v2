class riscv_base_test extends uvm_test;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        if (!uvm_config_db#(virtual cpu_interface)::get(this, "*", "monitor_vif", cfg.monitor_vif))
            `uvm_fatal(get_type_name(), "Monitor virtual interface not found in config DB")
        if(!uvm_config_db#(virtual cpu_interface)::get(this, "*", "driver_vif", cfg.driver_vif))
        ...
        // Pass Spike log path to the flow predictor
        uvm_config_db#(string)::set(this, "env.flow_predictor", "SPIKE_LOG", spike_log_path);
