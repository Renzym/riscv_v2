...
class riscv_instr:
    ...
    def create_instr_list(cls, cfg):
        ...
        for instr_name, instr_group in cls.instr_registry.items():
            ...
            cls.instr_template[instr_name.name] = instr_inst
            ...
            if (instr_inst.group in rcs.supported_isa and
                ...
                cls.instr_category[instr_inst.category.name].append(instr_name.name)
                cls.instr_group[instr_inst.group.name].append(instr_name.name)
                cls.instr_names.append(instr_name.name)
