...
def get_project_root():
    ...
    # Assume root is the parent of the 'scripts' directory
...
def run_test_generation(seeds):
    ...
    if "PYTHONPATH" in env:
        ...
        # Use environment variables for test name, target package, and ISA.
        # The custom target directory is still named rv32i, but its setting file
        # enables RV32M. Keep --target as the package name and --isa as RV32IM.
    test_name = os.environ.get("TEST_NAME", "riscv_arithmetic_basic_test")
    target_name = os.environ.get("RISCV_DV_TARGET", "rv32i")
    target_isa = os.environ.get("TARGET_ISA", "rv32im")
